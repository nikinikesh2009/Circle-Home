export default function PrivacyPage() {
  return (
    <div className="max-w-4xl mx-auto prose prose-lg">
      ...
      <p>
        We use the information we collect to provide, maintain, and improve our services, such as to administer your use of our services, to communicate with you about products, services, offers, promotions, and events, and provide other news and information we think will be of interest to you.
      </p>
      ...
      <p>
        You may update, correct or delete information about you at any time by logging into your online account. If you wish to delete or deactivate your account, please email us at support@circle.example.com, but note that we may retain certain information as required by law or for legitimate business purposes.
      </p>

      <h2>5. Contact Us</h2>
      <p>
        If you have any questions about this Privacy Policy, please contact us at: privacy@circle.example.com.
      </p>
    </div>
  );
}
